...
class EncoderOdometry(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter('wheel_base', 0.298)        # CubeRover 2U: 298mm track width (X=±149mm)
        self.declare_parameter('wheel_radius', 0.100)     # CubeRover 2U: 200mm diameter wheels (R=100mm)
